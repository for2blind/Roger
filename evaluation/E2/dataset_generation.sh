cd /home/pengshijie/roger/benchmark/GPT/PARAM-8
faas-cli deploy -f config.yml --gateway=http://172.169.8.253:31112 --namespace=cdgp --env retry_check='true' --env infer_device='cuda'
cd /home/pengshijie/roger/benchmark/BERT/PARAM-8
faas-cli deploy -f config.yml --gateway=http://172.169.8.253:31112 --namespace=cdgp --env retry_check='true' --env infer_device='cuda'
cd /home/pengshijie/roger/benchmark/LLAMA/PARAM-7
faas-cli deploy -f config.yml --gateway=http://172.169.8.253:31112 --namespace=cdgp --env retry_check='true' --env infer_device='cuda'
cd /home/pengshijie/roger/benchmark/stream/
